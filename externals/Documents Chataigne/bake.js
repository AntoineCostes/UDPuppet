...
var coilParam = script.addTargetParameter("Layer Bobine","");
...
/*
script.log(ampoule.layerParams[0]["name"]);
script.log(ampoule.layerParams[0]["param"]);
script.log(ampoule.layerParams[0]["param"].getTarget().getType());
//script.log(ampoule.layerParams[0]["type"]);
script.log(seqParam.getTarget().layers.getItems()[0]);
return;*/
