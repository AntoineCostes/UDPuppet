...
var jawLayerParam = script.addTargetParameter("Jaw","");
jawLayerParam.setAttribute("targetType","container");
jawLayerParam.setAttribute("searchLevel",0);
jawLayerParam.setAttribute("readOnly",true);

var rotationLayerParam = script.addTargetParameter("Rotation","");
rotationLayerParam.setAttribute("targetType","container");
rotationLayerParam.setAttribute("searchLevel",0);
rotationLayerParam.setAttribute("readOnly",true);

var ledLayerParam = script.addTargetParameter("Color","");
ledLayerParam.setAttribute("targetType","container");
ledLayerParam.setAttribute("searchLevel",0);
ledLayerParam.setAttribute("readOnly",true);
...
var layerParams = [ledLayerParam, jawLayerParam, rotationLayerParam];
...
if (jawLayerParam.get() != "")
{
		var obj = getObject("Castafiore");
		obj.layerParams = [];
		obj.layerParams[0] = {"name":"color", "param":ledLayerParam, "type":"Color"};
		obj.layerParams[1] = {"name":"jaw", "param":jawLayerParam, "type":"Mapping"};
		obj.layerParams[2] = {"name":"rotation", "param":rotationLayerParam, "type":"Mapping"};
}
