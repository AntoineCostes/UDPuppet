...
var layer1Param = script.addTargetParameter("Layer 1","");
layer1Param.setAttribute("targetType","container");
layer1Param.setAttribute("searchLevel",0);
layer1Param.setAttribute("readOnly",true);

var layer2Param = script.addTargetParameter("Layer 2","");
layer2Param.setAttribute("targetType","container");
layer2Param.setAttribute("searchLevel",0);
layer2Param.setAttribute("readOnly",true);

var layer3Param = script.addTargetParameter("Layer 3","");
layer3Param.setAttribute("targetType","container");
layer3Param.setAttribute("searchLevel",0);
layer3Param.setAttribute("readOnly",true);

var layer4Param = script.addTargetParameter("Layer 4","");
layer4Param.setAttribute("targetType","container");
layer4Param.setAttribute("searchLevel",0);
layer4Param.setAttribute("readOnly",true);
...
var layerParams = [layer1Param, layer2Param, layer3Param, layer4Param];
