#line 1 "C:\\Users\\Antoine\\git\\UDPuppet\\librairies\\AccelStepper_modified\\src\\AccelStepper.h"
// AccelStepper.h
//
...
public:
    ...
    AccelStepper(std::function<void()> forwardFunc, std::function<void()> backwardFunc);
